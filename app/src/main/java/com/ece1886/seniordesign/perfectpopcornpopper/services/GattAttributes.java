...
public class GattAttributes {
    ...
    public static String POPCORN_SERVICE = "B7DC42CB-F1B3-430C-A853-84BB6D17997A";
    public static String POPCORN_CHARACTERISTIC = "3618B05C-BC4A-41D2-B96D-AE491A9BFA78";

    public static final int POPCORN_LEVEL_READ = 10;

    static {
        //my stuff
        attributes.put(POPCORN_SERVICE, "Popcorn Service");
        attributes.put(POPCORN_CHARACTERISTIC, "Popcorn Characteristic");
